                ...
                <div class="row">
                    <div class="span8">
                        <div class="pages">
                            <!-- START ABOUT US -->
                            <div>
                            	<h3 style="margin-left: 210px"> <s:property value="#dynamic.dynamic_title" /> </h3>
                            </div>
                           <!--
                           ...
                           -->
                            ...
                            -->
                            <div>
							 <s:iterator value="#dynamic.dynamic_list" var="dynamictext">
							 	<p> <s:property value="#dynamictext" /> </p>
							 </s:iterator>                     
                            </div>
