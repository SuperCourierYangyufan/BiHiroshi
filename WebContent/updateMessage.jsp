                ...
                <div class="row">
                    <div class="span8">
                        <div class="pages">
                            <!-- START ABOUT US -->
                            <div>
                            	<h3 style="margin-left: 230px">修改留言</h3>
                            </div>
                           <!--
                           ...
                           -->
                            ...
                            -->
                       		<div style="margin-right:100px;">
						   		<form action="${pageContext.request.contextPath}/Message_updateMessage" method="post">
						   				<textarea name="message_text" class="form-control" rows="3" style="height: 550px; width: 600px;" ><s:property value="#message.message_text"/> </textarea><br />
						   			<div style="margin-left: 260px">
						   				<button type="submit" class="btn btn-info">确认修改</button>
						   			</div>
						   			<input type="hidden" name="message_uuid"  value="<s:property value="#message.message_uuid" />" />
						   			<input type="hidden" name="message_id"  value="<s:property value="#message.message_id" />" />
								</form>
						   	</div>
