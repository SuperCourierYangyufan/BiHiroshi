...
<script type="text/javascript">
		function toaddDynamic(){
			window.location.href="${pageContext.request.contextPath}/addDynamic.jsp";	
		}
            ...
            <div class="container">
                <div class="row">
                    <div class="span8">
                        <div class="pages">
                            <!-- START ABOUT US -->
                            <div class="pages_title">我的动态</div>
                            <button type="button" class="btn btn-info" onclick="toaddDynamic()">添加动态</button>
                           <!--
                           ...
                           -->
                            ...
                            <form method="post" action="#">
								<table class="table table-bordered" style="table-layout:fixed;" >
									<tr>
										<td colspan="3" style="WORD-WRAP: break-word">标题</td>
										<td colspan="1">时间</td>
										<td colspan="1">操作</td>	
									</tr>
									<!-- <tr>
										<td colspan="3" style="WORD-WRAP: break-word">spring原理</td>
										<td colspan="1">1996-09-01</td>
										<td>
									...
									<s:iterator value="#dynamicList" var="dynamic">
									 <tr>
										<td colspan="3" style="WORD-WRAP: break-word">
										<a href="${pageContext.request.contextPath}/DynamicAction_showDynamic?dynamic_id=<s:property value="#dynamic.dynamic_id" />"><s:property value="#dynamic.dynamic_title" /></a>
										<td colspan="1"><s:property value="#dynamic.dynamic_time" /></td>
										<td>
											<a href="${pageContext.request.contextPath }/DynamicAction_deleteDynamic?dynamic_id=<s:property value="#dynamic.dynamic_id" />"><font color="red">删除</font></a>
											<font color="red">|</font>
											<a href="${pageContext.request.contextPath }/DynamicAction_updateDynamic?dynamic_id=<s:property value="#dynamic.dynamic_id" />"><font color="red">修改</font></a>
										</td>	
									</tr>
									</s:iterator>
								</table>                       	
