                ...
                <div class="row">
                    <div class="span8">
                        <div class="pages">
                            <!-- START ABOUT US -->
                            <div>
                            	<h3 style="margin-left: 210px">修改动态</h3>
                            </div>
                           <!--
                           ...
                           -->
                            ...
                            -->
                       		<div style="margin-right:100px;">
						   		<form action="${pageContext.request.contextPath}/DynamicAction_toupdateDynamic" method="post" enctype="multipart/form-data">
						   				<input type="text" name="dynamic_title" value='<s:property  value="#dynamic.dynamic_title"/>' class="form-control" id="exampleInputName2" placeholder="标题" style="margin-left: 110px;height: 25px;width: 350px">
						   				<textarea name="dynamic_InputText"  class="form-control" rows="3" style="height: 550px; width: 600px;" ><s:iterator value="#dynamic.dynamic_list" var="text"><s:property  value="#text" /></s:iterator></textarea><br />
						   				<input type="hidden"   name="dynamic_uuid"   value="<s:property value='#dynamic.dynamic_uuid' />">
						   				<input type="hidden"   name="dynamic_id"   value="<s:property value='#dynamic.dynamic_id' />">
