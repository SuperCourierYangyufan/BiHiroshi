                ...
                <div class="row">
                    <div class="span8">
                        <div class="pages">
                            <!-- START ABOUT US -->
                            <div>
                            	<h3 style="margin-left: 230px">添加留言</h3>
                            </div>
                           <!--
                           ...
                           -->
                            ...
                            -->
                       		<div style="margin-right:100px;">
						   		<form action="${pageContext.request.contextPath}/Message_add" method="post">
						   				<textarea name="message_text" class="form-control" rows="3" style="height: 550px; width: 600px;" ></textarea><br />
